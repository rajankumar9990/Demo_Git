...
public class HealthyAgingFormPage {
	...
	// Example checkboxes and radios – verify actual IDs/text in DOM
	...
	private By countyEscambiaRadio = By.xpath(
			"//*[@id=\"post-500\"]/div/div[1]/div/div[1]/div/form/div/div/div[1]/div/div[4]/fieldset[2]/div[1]/div[1]/div/label[1]/span[1]/span");
	...
	private By submitButton = By
			.xpath("//*[@id=\"post-500\"]/div/div[1]/div/div[1]/div/form/div/div/div[1]/div/div[10]/button/span/span");
	 ...
	 * Thread.sleep(1000); driver.findElement(nopreferenceRadio).click(); }
	 */
